...
import { IncomeCategoryResponse } from '@/@types/dbTypes'
...
export const IncomeCreateModal: FC<Props> = ({ buttonType, buttonTitle, data, title, actionUrl, categories }) => {
                ...
                <div className="fixed inset-0 z-10 flex items-center justify-center">
                    ...
                    <div className="relative z-20 w-full max-w-md transform overflow-hidden rounded-lg bg-white px-6 py-4 shadow-xl transition-all sm:max-w-lg">
                        ...
                        <form action={actionUrl} method='post' className="space-y-4">
                            ...
                            <div>
                                <label htmlFor="income_category_id" className="block text-sm font-medium text-gray-700">
                                    カテゴリID
                                </label>
                                <select

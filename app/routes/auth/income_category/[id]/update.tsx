...
export default createRoute(async (c) => {
    ...
    const detail = await client.getDetail<IncomeCategory>({ endpoint: endPoint, contentId: id })
    return c.render(
        <>
            <CategoryCreateForm
...
export const POST = createRoute(
    ...
    async (c) => {
        ...
        const response = await client.updateData<IncomeCategory>({ endpoint: endPoint, contentId: id, data: body })

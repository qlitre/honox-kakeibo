...
export default createRoute(async (c) => {
    ...
    const incomeCategoryResponse = await client.getListResponse<IncomeCategoryResponse>({
        endpoint: 'income_category'
    })
    const expenseCategoryResponse = await client.getListResponse<ExpenseCategoryResponse>({

...
export const getAndValidateFormData = async (
...
export const generateQueryBindValues = async (
  tableName: TableName,
  data: Record<string, any>,
) => {
  const fields = [
    ...schema[tableName].requiredFields,
    ...schema[tableName].optionalFields,
  ].flat();
...
export const buildSqlOrderByClause = (
  tableName: TableName,
  orderParams: string,
) => {
